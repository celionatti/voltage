...
namespace celionatti\Voltage\HTTP;
...
class Response
{
    ...
    protected static function statusText($statusCode)
    {
        $statusTexts = [
    ...
    public function jsonContent(array $data)
    {
        $this->setHeader('Content-Type', 'application/json');
        $this->setContent(json_encode($data));
    }

    public function plainTextContent($text)
    {
        $this->setHeader('Content-Type', 'text/plain');
        $this->setContent($text);
    }

    public function fileContent($filePath)
    {
